...
public class ParameterHandler_UrlTest {
    ...
    public void testApplyWithFullUrl() throws Exception {
        ...
        verify(request).useUrl("1234");
        verifyNoMoreInteractions(request);
    }


    private com.infamous.framework.http.Url getAnnotation(boolean withFullUrl) {
        return (com.infamous.framework.http.Url) (RestClientTest.class.getMethods()[withFullUrl ? 4 : 3]).getParameterAnnotations()[0][0];
    }
}
