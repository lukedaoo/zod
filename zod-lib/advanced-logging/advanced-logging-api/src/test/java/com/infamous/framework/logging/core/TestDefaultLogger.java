...
class TestDefaultLogger implements AdvancedLogger {

    private Logger m_slf4jLogger;

    public TestDefaultLogger(Class<?> clazz) {
        m_slf4jLogger = org.slf4j.LoggerFactory.getLogger(clazz);
    }

    public TestDefaultLogger(String category) {
    ...
    public LogKey getKey() {
        return new LogKey("defaultLogger", "debug", "global");
    }
